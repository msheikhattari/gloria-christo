...
**Related practices:** prayer journal, the seven Penitential Psalms cycle, sitting with grief
...
| Reference | Substance |
|---|---|
| **Psalm 3** | David fleeing Absalom — "LORD, how are they increased that trouble me!" |
...
| **Psalm 38** | sickness as discipline; "there is no soundness in my flesh" |
| **Psalm 39** | brevity of life; "make me to know mine end" |
| **Psalm 42-43** | "Why art thou cast down, O my soul?" — three iterations of the same self-question |
| **Psalm 51** | David after Bathsheba — the canonical penitential lament |
| **Psalm 88** | the darkest psalm — the only lament with no resolution toward trust |
...
| **Habakkuk 1-3** | the prophet's lament + the answer + the closing trust |
| **Job 3, 7, 10, 13, 14** | Job's laments — chapter-length sustained address |
...
| **Psalm 79** | the sanctuary defiled |
| **Psalm 80** | "Turn us again, O God" — recurring refrain |
| **Psalm 137** | "By the rivers of Babylon, there we sat down, yea, we wept" |
| **Lamentations 1-5** | book-length communal lament; alphabetic acrostic structure as form-discipline |
| **Joel 1-2** | locust-plague lament transitioning to call for repentance |

### NT extensions

| Reference | Substance |
|---|---|
| **Matthew 27:46 / Mark 15:34** | Christ's cry from the cross, citing Ps 22:1 |
| **Romans 8:18-27** | the groaning of creation + the Spirit's groans-too-deep-for-words |
| **Hebrews 5:7** | "with strong crying and tears" — Christ's prayer in the days of his flesh |
| **Revelation 6:9-10** | the martyrs under the altar: "How long, O Lord, holy and true" |
...
- ***siḥah*** (שִׂיחָה) — contemplative inner discourse, rumination, complaint addressed to God. Same root used in Ps 1:2 ("in his law doth he meditate day and night") and Ps 119:15, 23, 27, 48, 78, 97, 99, 148. Lament is *siḥah* in the agonized register.
- ***yir'ah*** (יִרְאָה) — the fear of the LORD, the foundation of wisdom (Prov 1:7). The "casting off" of *yir'ah* is what Eliphaz wrongly accuses Job of — see below.
- ***yāḥal*** (יָחַל) — to wait, to hope. Used heavily in lament psalms (Ps 31:24, 33:18, 42:5, 130:5, Lam 3:21). The companion virtue to lament: waiting *while* lamenting.
- ***'ad-mātay*** (עַד־מָתַי) — "how long?" The signature phrase of personal lament. Appears in Ps 6:3, 13:1-2, 35:17, 74:10, 79:5, 80:4, 89:46, 90:13, 94:3, Hab 1:2.
...
- **LXX numbering** shifts the Psalter from Ps 10 onward by one (LXX/Hebrew offset). Brenton's Psalter follows LXX; KJV follows Hebrew.
- **Patristic readings** often apply individual laments Christologically — Ps 22 read as Christ's voice on the cross; Ps 31 ("into thine hand I commit my spirit") read as Christ's final word. This is not a substitution for the Davidic/historical reading; it's a layering.
- **Sufi register** — the lover's complaint to the Beloved is the highest form of love, not its withdrawal. Rumi's Mathnawi opens with the *ney's* lament: separation is the song. The same gesture as the Psalter.
- **Hesychast register** — *penthos*, holy mourning, is treated as a stage on the ladder (Climacus, *Ladder of Divine Ascent*, Step 7). Tears in prayer are not breakdown; they are charism.
- **Lament and praise are not opposites** — they are two postures within the same address. The Psalter teaches that the spiritual life requires both registers, that pure praise without lament hides the real material, and pure lament without trust collapses into despair.
...
- The prayer journal as a lament-template (Westermann's structure as scaffolding for the journal entry)
- The body of lament before sleep — duration practice, willingness to stay in the *siḥah* until something shifts
- Memorizing the lament psalms — Ps 13, 22, 42, 51, 88, 130, 143 as the apprenticeship corpus
- Communal lament as a discipline — reading Lamentations 3 aloud at a memorial; praying Ps 79 / 80 / 137 corporately during national crisis
- The Job-vs-Eliphaz diagnostic: when discomfort with someone's prayer arises, am I Eliphaz?
...
- [`../practices/praying-scripture.md`](../practices/praying-scripture/) — the broader lens; lament is one specific mode of praying scripture
- [`../concordance/law-heart.md`](../concordance/law-heart/) — the broken/contrite-heart cluster
