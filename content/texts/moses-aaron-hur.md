...
**Related practices:** prayer log, salah, intercession, sustained du'a, third-register service
...
- **Joshua** — the fighter (active in the world)
- **Moses** — the pray-er (the one whose hands rise toward heaven)
- **Aaron + Hur** — the sustainers (who hold up the pray-er)
...
- **Fighter** — the active work in the world (vocation, building, defending)
- **Pray-er** — the contemplative work (silence, sitting, fixed-hour prayer)
- **Sustainer** — the held-up-the-arms work (mentoring, accompanying, supporting another's labor)
