...
**Related practices:** sustained address through dryness, vow-payment, intercession without expectation
...
- [`./job-1-9-satan.md`](./job-1-9-satan/) *(future)* — Satan's foundational accusation
- [`./job-16-17.md`](./job-16-17/) — Job's *zakkāh* prayer: the relational direction articulated
- [`./job-21-15.md`](./job-21-15/) — the wicked's transactional rejection; Satan's question made explicit
- [`./job-22-27.md`](./job-22-27/) — Eliphaz's transactional promise; the inverted fulfillment in chapter 42
- [`./lament.md`](./lament/) — the prayer mode that survives the absence of payoff
- [`./intercession.md`](./intercession/) — the intercessor's vow that does not depend on the recipient's worthiness or response
- [`./moses-aaron-hur.md`](./moses-aaron-hur/) — *emunah* as load-bearing form, not transaction
