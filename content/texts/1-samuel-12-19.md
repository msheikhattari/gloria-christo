...
**Related themes:** intercession, the visible-king-vs-hidden-God archetype
...
Samuel does not abandon the people who have rejected his sons and through them rejected him. He does not say *I told you so*. He commits to continued intercession ("ceasing to pray for you" would itself be sin) and to continued teaching. The intercessor's posture: the people's failure does not release the intercessor from the prayer. See [`./intercession.md`](./intercession/).
...
Nehemiah's confession centuries later (Neh 1:6 — *"we have sinned... both I and my father's house"*) reaches back across the whole arc. The "father's house" he invokes is the accumulated weight of the monarchic period that began with this verse. See [`./intercession.md`](./intercession/) for the full arc-closure.
...
Practice corollary: not every request fulfilled is a confirmation. The deeper discipline is praying for what God already promises is good (see [`../practices/praying-scripture.md`](../practices/praying-scripture/)), rather than for what the praying mind has decided it wants.
...
This is the same diagnostic at work in the Eliphaz-vs-Job distinction (see [`./lament.md`](./lament/)) — religious certainty that has stopped addressing God is a *zahir* posture (visible-form without inner-substance), even when its vocabulary is orthodox.
...
- [`./intercession.md`](./intercession/) — Samuel as paradigm intercessor; the corporate-confession arc from this verse through Nehemiah
- [`./prayer-and-watch.md`](./prayer-and-watch/) — Nehemiah's corrected pattern (the failure here is the warrant for the corrective there)
- [`./lament.md`](./lament/) — the *zahir/bāṭin* diagnostic appears also in the Eliphaz-Job dynamic
- [`../practices/praying-scripture.md`](../practices/praying-scripture/) — the discipline of praying for what scripture identifies as worth asking, rather than what the praying mind has decided
